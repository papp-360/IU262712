let persona_def_tests = Array(
    //campos no ficheros
    ['persona','nombre_persona','input',1,'cumple tamaño minimo','min_size','ADD','nombre_persona_min_size_ko','Tamaño muy corto. Debe estar entre 2 y 45 caracteres'],
    ['persona','nombre_persona','input',2,'cumple tamaño maximo','max_size','ADD','nombre_persona_max_size_ko','Tamaño muy grande. Debe estar entre 2 y 45 caracteres'],
    ['persona','nombre_persona','input',3,'cumple formato','format','ADD','nombre_persona_format_ko','Formato inválido. Debe estar entre 2 y 45 caracteres alfabéticos'],
    ['persona','nombre_persona','input',4,'es correcto','valid','ADD',true,'Nombre persona correcto'],
    ...
    ['persona','nuevo_foto_persona','file',9,'existe fichero en foto_persona','exist_file','ADD','foto_persona_exist_file_ko','No existe foto. Debe subir una foto en jpg'],
    ['persona','nuevo_foto_persona','file',10,'foto persona formato incorrecto','format_name_file','ADD','foto_persona_format_name_file_ko','nombre de foto incorrecto. Deben ser alfabeticos sin acentos'],
    ['persona','nuevo_foto_persona','file',11,'foto persona tamaño excesivo','max_size_file','ADD','foto_persona_max_size_file_ko','Tamaño fichero foto excesivo. Deben ser menor de 20000 bytes'],
);
